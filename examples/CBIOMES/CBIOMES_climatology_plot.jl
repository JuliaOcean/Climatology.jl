...
begin
	using Climatology, MeshArrays, NCDatasets
...
The inputs to this notebook is the file generated by [that other notebook](https://gaelforget.github.io/Climatology.jl/v0.1.13/examples/CBIOMES_model_climatogy.html), downloaded from [this zenodo archive](https://doi.org/10.5281/zenodo.5598417).
...
begin
	if file_selection == 1
		path0=Climatology.CBIOMESclim_download("clim1")
		fil_out=joinpath(path0,"CBIOMES-global-alpha-climatology.nc")
	elseif file_selection == 2
		path0=Climatology.CBIOMESclim_download("PML1")
...
manifest_format = "2.0"
project_hash = "2ea77b08f2a5351053c3d73814fe16b186ad8693"
