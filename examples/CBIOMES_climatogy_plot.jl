...
begin
	v_lst = keys(nc)
	tst=(v_lst.=="t").+(v_lst.=="lon").+(v_lst.=="lat").+(v_lst.=="tim").+(v_lst.=="climatology_bounds")
	v_lst=v_lst[findall(tst.==0)]

	vv = @bind v PlutoUI.Select(v_lst)
	mm = @bind m PlutoUI.NumberField(1:12, default=1)
	md"""## Select Variable
...
git-tree-sha1 = "8f9eacbf80424989124dbb02fb1aa77b8bef74c3"
