...
using PlutoUI, CairoMakie, NCDatasets, Dataverse, Dates, Statistics

# ╔═╡ 474b2029-b125-451d-a5a1-988169570c82
module myinclude 
	using HTTP, JSON
	using DataFrames, Dates, Statistics
	include("NSLCT_notebook_module.jl")
end
...
md"""## Get Data via NASA/SLCT API

This data set is from _Fournier S., Willis J., Killett E., Qu Z. and Zlotnicki V. 2022_ [product JPL2205](https://podaac.jpl.nasa.gov/dataset/SEA_SURFACE_HEIGHT_ALT_GRIDS_L4_2SATS_5DAY_6THDEG_V_JPL2205)
"""

# ╔═╡ b053b44a-02cf-49a4-9dec-754a34f16027
md"""## Get Data via Dataverse API

The data set below is from _Frederikse, T.; Landerer, F.; Caron, L.; Adhikari, S.; Parkes, D.; Humphrey V.; Dangendorf, S.; Hogarth, P.; Zanna, L.; Cheng, L.; Wu, Y. 2020_ <https://doi.org/10.1038/s41586-020-2591-3>
"""
...
begin
	...
	measures_ssh_short_name="JPL2205"
	measures_ssh_ts=NSLCT.get_ssh_ts(measures_ssh_nam)
	"Done"
end	

# ╔═╡ c7ed0b20-2472-4728-ac00-b0e82b7d2269
begin
	f=Figure(size=(900,200)); ax=Axis(f[1,1])
	lines!(ax,ecco_ssh_ts.tim,ecco_ssh_ts.sla)
	f
end
...
let
	...
	lines!(ax,ecco_ssh_ts.tim,ecco_ssh_ts.sla,label=ecco_ssh_short_name)
	lines!(ax,measures_ssh_ts.tim,measures_ssh_ts.sla,label=measures_ssh_short_name)
	axislegend(position=:rb); limits!(ax,1992,2020,-0.2,0.2)
...
function plot_gmsl(d)
	...
	ax.title[]="global_timeseries_measures.nc"
	f0
end
...
manifest_format = "2.0"
project_hash = "9d6c7111bc0e4f4dc455a4f285f5b35c58a3427a"
...
git-tree-sha1 = "7a2834267e01ca1a1e504196708230ac41f6d4fa"
