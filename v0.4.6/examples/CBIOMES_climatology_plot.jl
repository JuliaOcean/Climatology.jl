...
let
	fig = Figure(size = (600,400), backgroundcolor = :grey95, fontsize=12)
...
let
	...
	fig = Figure(size = (600,300), backgroundcolor = :grey95, fontsize=12)
...
let
	...
	fig = Figure(size = (900,600), backgroundcolor = :grey95, title="lon0,lat0=$(lon0),$(lat0)" , fontsize=12)
...
manifest_format = "2.0"
project_hash = "fc9ac780ee1610ce4fbee24ec4436611d28d5f26"
